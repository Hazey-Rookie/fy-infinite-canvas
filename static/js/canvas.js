...
// MiniMax H3 canvas limits and workflow defaults (kept in sync with upstream).
...
const CANVAS_IMAGE_OUTPUT_TYPES = ['generator','midjourney','msgen','comfy','ltxDirector','rh','minimax'];
