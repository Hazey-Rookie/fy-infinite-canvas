...
async function loadData(refresh=false){
    ...
    try{
        ...
        if(isPlatformAdmin()&&state.auth?.config?.local_auth_enabled){const accounts=await api(scopedUrl('/api/admin/local-accounts'));state.localAccounts=accounts.accounts||[];}else state.localAccounts=[];
